...
saveRDS(bars_on_mur, file = "Data/bars_on_mur.rds")
saveRDS(bars_on_lac, file = "Data/bars_on_lac.rds")
saveRDS(bars_on_mac, file = "Data/bars_on_mac.rds")
saveRDS(bars_on_nam, file = "Data/bars_on_nam.rds")
saveRDS(bars_on_gwy, file = "Data/bars_on_gwy.rds")
saveRDS(bars_on_dum, file = "Data/bars_on_dum.rds")

#Saving electrofishing site shapefiles
saveRDS(sites_on_mur, file = "Data/sites_on_mur.rds")
saveRDS(sites_on_lac, file = "Data/sites_on_lac.rds")
saveRDS(sites_on_mac, file = "Data/sites_on_mac.rds")
saveRDS(sites_on_nam, file = "Data/sites_on_nam.rds")
saveRDS(sites_on_gwy, file = "Data/sites_on_gwy.rds")
saveRDS(sites_on_dum, file = "Data/sites_on_dum.rds")
